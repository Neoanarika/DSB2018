...
class Configuration(object):
    ...
    def __init__(self):
        ...
        #multi-rpn
        self.rpn_base_sizes         = [ 8, 16, 32, 64] #diameter 8, 16, 32, 64
        self.rpn_base_apsect_ratios = [ 1,  ]
        self.rpn_num_bases = len(self.rpn_base_sizes) *len(self.rpn_base_apsect_ratios)
        ...
        #mask
        self.mask_size  = 28
        self.mask_train_batch_size  = 128
