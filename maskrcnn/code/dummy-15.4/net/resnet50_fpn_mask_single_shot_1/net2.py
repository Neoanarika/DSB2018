...
class FeatureNet(nn.Module):
    ...
    def __init__(self, cfg, in_channels, out_channels=256 ):
        ...
        self.layer_c2 = make_layer_c(  128,  64,  256, num_blocks=2, stride=2)
        self.layer_c3 = make_layer_c(  256, 128,  512, num_blocks=3, stride=2)
        self.layer_c4 = make_layer_c(  512, 256, 1024, num_blocks=3, stride=2)
    ...
    def forward(self, x):
        ...
        assert(self.cfg.rpn_scales == len(features))
...
class MaskSingleShotNet(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.crop      = CropRoi (cfg,feature_channels, 128)
        self.mask_head = MaskHead(cfg,128*4)
