...
def draw_multi_rpn_delta(cfg, image, rpn_prob_flat, rpn_delta_flat, window):
    ...
    for i in index:
        ...
        cv2.rectangle(image_box,(x0,y0), (x1,y1), (0,0,255), 1)
        image_point[cy,cx]= [0,0,255]
        ...
        if 1:
            ...
            for i,b in enumerate(truth_box):
                ...
                if truth_result[i]==MISS:
                    cv2.rectangle(image_truth,(x0,y0), (x1,y1), (0,255,255), 1)
                    cv2.rectangle(image_miss,(x0,y0), (x1,y1), (0,255,255), 1)
            ...
            for i,b in enumerate(box):
                ...
                if result[i]==FP:
                    cv2.rectangle(image_fp,(x0,y0), (x1,y1), (255,0,255), 1)
...
def draw_mask_metric(cfg, image, mask, truth_box, truth_label, truth_instance):
    ...
    draw_shadow_text(all,'%0.2f prec'%average_precision,  (5,H-15),0.5, (0,0,255), 1)
