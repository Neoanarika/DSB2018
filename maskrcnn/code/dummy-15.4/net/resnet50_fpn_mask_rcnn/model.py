...
from net.resnet50_fpn_mask_rcnn.configuration import*

#from net.lib.roi_align_pool.module import RoIAlignAvg as Crop
from net.lib.roi_align_pool_tf.module import RoIAlign as Crop




from net.resnet50_fpn_mask_rcnn.layer.rpn_nms import *
from net.resnet50_fpn_mask_rcnn.layer.rpn_target import *
from net.resnet50_fpn_mask_rcnn.layer.rpn_loss import *

# from net.resnet50_fpn_mask_rcnn.layer.rcnn_nms import *
# from net.resnet50_fpn_mask_rcnn.layer.rcnn_target import *
# from net.resnet50_fpn_mask_rcnn.layer.rcnn_loss import *
#
# from net.resnet50_fpn_mask_rcnn.layer.mask_nms import *
# from net.resnet50_fpn_mask_rcnn.layer.mask_target import *
# from net.resnet50_fpn_mask_rcnn.layer.mask_loss import *
...
def make_layer_c0a(in_planes, out_planes):
    layers = [
...
class FeatureNet(nn.Module):
    ...
    def __init__(self, cfg, in_channels, out_channels=256 ):
        ...
        self.layer_c1 = make_layer_c(   64,  32,  128, num_blocks=2, stride=1)
...
class RpnHead(nn.Module):
    ...
    def __init__(self, cfg, in_channels):
        ...
        self.num_bases  = len(cfg.rpn_base_apsect_ratios)


        self.conv  = nn.Conv2d(in_channels, 512, kernel_size=3, padding=1)
        self.logit = nn.Conv2d(512, self.num_bases,   kernel_size=1, padding=0)
...
class CropRoi(nn.Module):
    ...
    def forward(self, ps, proposals):
        ...
        #https://github.com/pytorch/pytorch/issues/2068
        gc.collect()
...
class MaskRcnnNet(nn.Module):
    ...
    def forward(self, inputs, truth_boxes=None,  truth_labels=None, truth_instances=None):
        ...
        self.rpn_proposals = rpn_nms(cfg, mode, inputs, self.rpn_logits_flat, self.rpn_deltas_flat, self.rpn_windows)

        # detection
        # if mode in ['train', 'valid']:
        #     self.rpn_labels, self.rpn_label_weights, self.rpn_targets, self.rpn_target_weights = \
        #         make_rpn_target(cfg, inputs, self.rpn_windows, truth_boxes, truth_labels )
        #
        #     self.rpn_proposals, self.rcnn_labels, self.rcnn_targets,   = \
        #         make_rcnn_target(cfg, inputs, self.rpn_proposals, truth_boxes, truth_labels)
        #
        #
        ...
        #
        # if self.rcnn_proposals is None:
        #     self.masks = make_empty_masks(cfg, mode, inputs)
        # else:
        #     if mode in ['train', 'valid']:
        #         self.rcnn_proposals, self.mask_labels, self.mask_instances,   = \
        #             make_mask_target(cfg, inputs, self.rcnn_proposals, truth_boxes, truth_labels, truth_instances)
        #
        #         pass
        #
        ...
        #     self.masks = mask_nms(cfg, mode, inputs, self.rcnn_proposals, self.mask_probs) #<todo> better nms for mask
