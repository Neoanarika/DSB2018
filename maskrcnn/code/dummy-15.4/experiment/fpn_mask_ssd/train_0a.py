...
from net.resnet50_fpn_mask_single_shot_0.draw  import *
...
def run_train():
    ...
    out_dir  = RESULTS_DIR + '/mask-single-shot-dummy-15b'
    initial_checkpoint = \
        RESULTS_DIR + '/mask-single-shot-dummy-15a/checkpoint/00013000_model.pth'
        ##None #
        ...
        for inputs, truth_boxes, truth_labels, truth_instances, metas, indices in train_loader:
            ...
            if 1:
                ...
                for b in range(batch_size):
                    ...
                    # image_show('mask_precision',all6,1)
